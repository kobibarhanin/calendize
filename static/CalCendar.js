...
function initiate(events,defaultDate) {
    ...
    $("#routine_button").unbind('click').click(function(){
        ...
        cell3.innerHTML = time_from
        cell4.innerHTML = time_to
        cell5.innerHTML = "<input id=cb_"+title+duration+" type='checkbox' name="+title+duration+" value='some_value'>"
